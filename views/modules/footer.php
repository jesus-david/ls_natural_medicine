        ...
        <div class="row mb-5">
            <div class="col-md">
                <div class="ftco-footer-widget mb-4">
                    <h2 class="ftco-heading-2">LS NARTURAL MEDICINE</h2>
            ...
            <div class="col-md">
                <div class="ftco-footer-widget mb-4 ml-md-5">
                    ...
                    <ul class="list-unstyled">
                        <li><a href="shop" class="py-2 d-block">Tienda</a></li>
                        <li><a href="about" class="py-2 d-block">Sobre nostros</a></li>
                ...
                <div class="ftco-footer-widget mb-4">
                    ...
                    <div class="d-flex">
                        <ul class="list-unstyled mr-l-5 pr-l-3 mr-4">
                            <li><a href="#" class="py-2 d-block">Política de devolución</a></li>
