<?php 
    ...
    if ($_SESSION["tipo"] != 0) {
        GestorConfigController::verficar_usuario("clients");
    } 

    $q = isset($_SESSION["filtrarClients"]) ? $_SESSION["filtrarClients"] : "";
?>
    ...
    <div
        ...
        <div class="kt-portlet kt-portlet--mobile">
            <div class="kt-portlet__body kt-portlet__body--fit">
                <!--begin: Datatable -->
                <div class="kt-datatable" id="kt_apps_clients_list_datatable">
                </div>
                <!--end: Datatable -->
            </div>
        </div>
