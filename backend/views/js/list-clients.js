...
$.ajax({
    url:"views/ajax/jsonClients.php",
    type: "POST",
    dataType: "JSON"
})
.done((res)=>{
...
var KTUserListDatatable = (function() {
    ...
    return {
        init: function() {
            (t = $("#kt_apps_clients_list_datatable").KTDatatable({
                data: {
                    type: "remote",
                    source: {
                        read: {
                            ...
                            return `
                                <div class="kt-user-card-v2">  
                                    <div class="kt-user-card-v2__details">
                                        <a href="editClient_${t.id}" class="kt-user-card-v2__name">
                                            ${t.nombre}
                                        </a>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="kt-nav">
                                        <li class="kt-nav__item">
                                            <a href="editClient_${t.id}" class="kt-nav__link">
                                                <i class="kt-nav__link-icon flaticon2-contract"></i>
                                                <span class="kt-nav__link-text">Editar</span>
                                            </a>
                                        </li>
                                        <li class="kt-nav__item">
                                            <a href="#" class="kt-nav__link borrarCliente" data-id="${t.id}">
                ...
                t.on("kt-datatable--on-layout-updated", function() {
                    $(".borrarCliente").unbind()
                    $(".borrarCliente").bind("click",function(e){
                        e.preventDefault()
                        var idBorrar = $(this).attr("data-id")
                        swal.fire({
                                buttonsStyling: !1,
                                text:
                                    "¿Estás seguro de borrar a este cliente?  Esto afectará los pedidos y las carteras de este cliente",
                                type: "error",
                                confirmButtonText: "Sí, borrar!",
                                confirmButtonClass:
                                    "btn btn-sm btn-bold btn-danger",
