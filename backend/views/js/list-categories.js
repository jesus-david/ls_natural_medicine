...
$.ajax({
    url:"views/ajax/jsonCategories.php",
    type: "POST",
    dataType: "JSON"
})
.done((res)=>{
...
var KTUserListDatatable = (function() {
    ...
    return {
        init: function() {
            (t = $("#kt_apps_companys_list_datatable").KTDatatable({
                data: {
                    type: "remote",
                    source: {
                        read: {
                            ...
                            return `
                                <div class="kt-user-card-v2">  
                                    <div class="kt-user-card-v2__details">
                                        <a href="products_${t.id}" class="kt-user-card-v2__name">
                                            ${t.nombre}
                                        </a>
                                ...
                                <div class="dropdown-menu dropdown-menu-right">
                                    <ul class="kt-nav">
                                        <li class="kt-nav__item">
                                            <a href="#" class="kt-nav__link editarCategoria" data-id="${t.id}" data-nombre="${t.nombre}"> 
                                                <i class="kt-nav__link-icon flaticon2-contract"></i>
                                                <span class="kt-nav__link-text">Editar</span>
                                            </a>
                                        </li>
                                        <li class="kt-nav__item">
                                            <a href="#" class="kt-nav__link borrarCategoria" data-id="${t.id}">
                            ...
                            swal
                                .fire({
                                    ...
                                    text:
                                        ...
                                        e.length +
                                        " empresa/s seleccionada/s? Esto afectará los productos afiliados a esta empresa.",
                                    type: "error",
                                ...
                                .then(function(t) {
                                    if (t.value) {
                                        ...
                                        var datos = {
                                            borrar_lista_empresas: true,
                                            lista: e.toArray()
                                        }

                                        ajax.peticion("normal",datos,"views/ajax/gestorEmpresas.php")
                                            .then((res)=>{                                                
                                                console.log(res)
                                                if (res.status == "ok") {
                                                    swal.fire({
                                                        title: "¡Borrado!",
                                                        text:
                                                            "¡Las empresas seleccionadas han sido borradas! :(",
                                                        type: "success",
                                                        buttonsStyling: !1,
                                                        confirmButtonText: "OK",
                                                        confirmButtonClass:
                                        ...
                                        swal.fire({
                                            title: "Cancelado",
                                            text:
                                                "¡Las empresas seleccionadas no han sido borradas! :)",
                                            type: "error",
                                            buttonsStyling: !1,
                                            confirmButtonText: "OK",
                                            confirmButtonClass:
                ...
                t.on("kt-datatable--on-layout-updated", function() {
                    ...
                    $(".borrarCategoria").unbind().bind("click",function(e){
                        e.preventDefault()
                        var idBorrar = $(this).attr("data-id")
                        swal.fire({
                                buttonsStyling: !1,
                                text:
                                    "¿Estás seguro de borrar esta categoría?",
                                type: "error",
                                confirmButtonText: "Sí, borrar!",
                                confirmButtonClass:
                                    "btn btn-sm btn-bold btn-danger",
                            ...
                            .then(function(t) {
                                if (t.value) {
                                    ...
                                    var datos = {
                                        borrar_lista_categorias: true,
                                        lista: [idBorrar]
                                    }
                
                                    ajax.peticion("normal",datos,"views/ajax/gestorCategorias.php")
                                        .then((res)=>{
                                            console.log(res)
                                            if(res.status == "ok"){
                                                swal.fire({
                                    ...
                                    swal.fire({
                                        title: "Cancelado",
                                        text:
                                            "¡La categoría no ha sido borrada! :)",
                                        type: "error",
                                        buttonsStyling: !1,
                                        confirmButtonText: "OK",
                                        confirmButtonClass:
                    ...
                    $(".editarCategoria").unbind().bind("click",function(e){
                        e.preventDefault()
                        var id = $(this).attr("data-id")
                        var nombre = $(this).attr("data-nombre")

                        $("#nombreCategoriaEditar").val(nombre)
                        $("#idCategoria").val(id)
